...
* [Тестировщикам](https://t.me/torsukov/6) оценить требования аналитика и разработать соответствующие проверки
...
<u>Прежде, чем приступить</u>

  * Определен класс продукта _<EDC,MES,BPMS и т.д.>_
    * Определены внешние документы, регламентирующие разработку определенного класса продукта _<ISO,ГОСТы и т.п.>_
    ...
    * Клиентская сторона ознакомлена с документом "_Билль о правах клиента ПО при формировании требований_"
...
<u>Пользовательский уровень</u>
  ...
  * Исследованы классы пользователей:
    ...
    * Исследованы ролевые модели пользователей результатов проекта: их особенности, контекст работы с системой, знания и квалификации и т.п. Поддерживается трассировка между бизнес-уровнем
